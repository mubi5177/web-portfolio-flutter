...
class Footer extends StatelessWidget {
  ...
  final String _description =
      "I am Flutter developer having around 1 years experience developing mobile applications, using different languages and techniques.";
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  'Proudly powered by Mubeen Ul Haq©${DateTime.now().year}',
                  style: TextStyle(
                    color: AppColors.greyLight!.withOpacity(.75),
                  ),
                ),
